            ...
            <div className="flex justify-between items-center">
                <div className="flex gap-3 items-center">
                    ...
                    <div className="flex flex-col">
                        <span className="text-slate-800 font-semibold text-[19px]">Project Title</span>
                        <span className="text-slate-500 text-[13px]">2 days ago</span>
                    </div>
                </div>
                <div>
        ...
        return (
            <ul className="text-slate-400 text-[13px] flex flex-col gap-2 ml-3">
                <li className="flex gap-2 items-center">
                    ...
                    <span>
                        Lorom Ipsum dolor, sit amet consectetur apising elit, Odit.
                    </span>
                </li>
                <li className="flex gap-2 items-center">
                    <CircleIcon className="text-[8px]"/>
